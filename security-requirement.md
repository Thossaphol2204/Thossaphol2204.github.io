...
**My self✨ :** หมายถึงการตรวจสอบว่ามีการใช้การเข้ารหัสกับการเชื่อมต่อทั้งขาเข้าและขาออกทั้งหมด  เพื่อให้แน่ใจว่าข้อมูลทั้งหมดปลอดภัยและได้รับการป้องกันอย่างเหมาะสม เพื่อป้องกันการรั่วไหลของข้อมูลหรือการโจมตีทางไซเบอร์
...
- **6530250433 Ponykorn Srinuchart**  
  > GitHub :🔗 [ponyakorn.github.io/security-requirement](https://ponyakorn.github.io/security-requirement)
